...
| G35 | 2026-08-27（契约 §8.1） | GPU 粒子系统期（对标并超越 UE5 Niagara 五轴：确定性 GPU 粒子/光追同帧碰撞/规模基元/XPBD 流体/数据驱动作者面——九门 + 收口门十门全兑现，soak 5010 帧 validation 静默，Stage A 锚 18/18 零回归；G18~G34 各期本表未逐期镜像，事实源恒为各契约 §8） |
...
| v1.5 | 2026-08-27 | 规划文档勘误(00 §6.3 追加式修订):§8 实况表追加 G35 行(GPU 粒子系统期收口,契约 §8.1;行内如实注明 G18~G34 未逐期镜像的间隔——各期事实源恒为各自契约 §8,本表只作索引镜像);§8 标题「G3~G17」范围字面为 v1.4 落笔快照不回写,表内容以行为准。既有行 0-byte |
