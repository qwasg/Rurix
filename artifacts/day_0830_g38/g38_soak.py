...
# G38 终验 soak(w6_full_soak.py 逐字复制 + 产物路径隔离到 day_0830_g38——
# 不覆盖 G37 档案;锚为运行时自举〔首迭代 32f 口径锚,后续位级恒值〕,法线 v2
# 重锚后零字面改动可直接跑,Stage A 探针/预算记账/VUID 判据不变)。
...
W6 = ROOT / "artifacts" / "day_0830_g38" / "soak"
EV = W6 / "soak_ev"
MIN_WALL_S = 1800.0
BUDGET_MS = 11.111
