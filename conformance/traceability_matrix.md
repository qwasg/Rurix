...
| RXS-0297 | spec/shader_stages.md | 5 | `conformance/rayquery/accept/ray_query_basic.rx`, `conformance/rayquery/accept/ray_query_first_hit.rx`, `conformance/rayquery/accept/ray_query_hit_miss.rx` …(+2) |
| RXS-0298 | spec/shader_stages.md | 4 | `conformance/rayquery/accept/ray_query_basic.rx`, `conformance/rayquery/accept/ray_query_first_hit.rx`, `conformance/rayquery/accept/ray_query_hit_miss.rx` …(+1) |
| RXS-0299 | spec/shader_stages.md | 7 | `conformance/rayquery/accept/ray_query_basic.rx`, `conformance/rayquery/accept/ray_query_first_hit.rx`, `conformance/rayquery/accept/ray_query_hit_miss.rx` …(+4) |
| RXS-0300 | spec/vulkan_backend.md | 6 | `conformance/rayquery/accept/ray_query_basic.rx`, `conformance/rayquery/accept/ray_query_first_hit.rx`, `conformance/rayquery/accept/ray_query_hit_miss.rx` …(+3) |
...
| RXS-0405 | spec/visual_comparison.md | 3 | `conformance/visual_comparison/accept/ue_upscale_parity_contract_minimal.rx`, `conformance/visual_comparison/reject/upscale_fps_baseline_masquerade.rx`, `conformance/visual_comparison/reject/upscale_parity_digest_mismatch_report.rx` |
| RXS-0406 | spec/visual_comparison.md | 3 | `conformance/visual_comparison/accept/ue_lumen_gi_parity_contract_minimal.rx`, `conformance/visual_comparison/reject/lumen_gap_silent.rx`, `conformance/visual_comparison/reject/lumen_parity_digest_mismatch_report.rx` |
| RXS-0407 | spec/visual_comparison.md | 3 | `conformance/visual_comparison/accept/absolute_pass_line_minimal.rx`, `conformance/visual_comparison/reject/absolute_pass_handwritten_threshold.rx`, `conformance/visual_comparison/reject/absolute_pass_verdict_masquerade.rx` |
