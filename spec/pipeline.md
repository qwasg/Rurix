...
- `SharedInner` 的 `unsafe impl Send + Sync`、`SharedEvent` 的 `unsafe impl Send` 经裁决最小开 + `// SAFETY:` + `unsafe-audit/rurix-rt.md`(U13/U14)注册;档位 Mini(§4),AI 不自判 Direct。
