...
// SPDX-License-Identifier: MIT
	...
	using JPH_float3 = JPH56::Float3;
	using JPH_float4 = JPH56::Float4;
	using JPH_uint = JPH56::uint32;
	using JPH_uint3 = JPH56::uint32[3];
	using JPH_uint4 = JPH56::uint32[4];
	using JPH_int = int;
	using JPH_int3 = int[3];
	using JPH_int4 = int[4];
	using JPH_Quat = JPH56::Float4;
	using JPH_Plane = JPH56::Float4;
	using JPH_Mat44 = JPH56::Float4[4]; // matrix, column major
