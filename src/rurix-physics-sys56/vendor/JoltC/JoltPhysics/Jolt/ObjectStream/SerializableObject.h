...
#define JPH_DECLARE_SERIALIZATION_FUNCTIONS(linkage, prefix, class_name)											\
	linkage prefix bool	OSReadData(JPH56::IObjectStreamIn &ioStream, class_name &inInstance);							\
	linkage prefix bool	OSReadData(JPH56::IObjectStreamIn &ioStream, class_name *&inPointer);							\
	linkage prefix bool	OSIsType(class_name *, int inArrayDepth, JPH56::EOSDataType inDataType, const char *inClassName);	\
	linkage prefix bool	OSIsType(class_name **, int inArrayDepth, JPH56::EOSDataType inDataType, const char *inClassName); \
	linkage prefix void	OSWriteData(JPH56::IObjectStreamOut &ioStream, const class_name &inInstance);					\
	linkage prefix void	OSWriteData(JPH56::IObjectStreamOut &ioStream, class_name *const &inPointer);					\
	linkage prefix void	OSWriteDataType(JPH56::IObjectStreamOut &ioStream, class_name *);								\
	linkage prefix void	OSWriteDataType(JPH56::IObjectStreamOut &ioStream, class_name **);

// JPH_IMPLEMENT_SERIALIZATION_FUNCTIONS
#define JPH_IMPLEMENT_SERIALIZATION_FUNCTIONS(class_name)															\
	bool		OSReadData(JPH56::IObjectStreamIn &ioStream, class_name &inInstance)									\
	{																												\
		return ioStream.ReadClassData(#class_name, (void *)&inInstance);											\
	}																												\
	bool		OSReadData(JPH56::IObjectStreamIn &ioStream, class_name *&inPointer)									\
	{																												\
		return ioStream.ReadPointerData(JPH_RTTI(class_name), (void **)&inPointer);									\
	}																												\
	bool		OSIsType(class_name *, int inArrayDepth, JPH56::EOSDataType inDataType, const char *inClassName)		\
	{																												\
		return inArrayDepth == 0 && inDataType == JPH56::EOSDataType::Instance && strcmp(inClassName, #class_name) == 0; \
	}																												\
	bool		OSIsType(class_name **, int inArrayDepth, JPH56::EOSDataType inDataType, const char *inClassName)		\
	{																												\
		return inArrayDepth == 0 && inDataType == JPH56::EOSDataType::Pointer && strcmp(inClassName, #class_name) == 0; \
	}																												\
	void		OSWriteData(JPH56::IObjectStreamOut &ioStream, const class_name &inInstance)							\
	{																												\
		ioStream.WriteClassData(JPH_RTTI(class_name), (void *)&inInstance);											\
	}																												\
	void		OSWriteData(JPH56::IObjectStreamOut &ioStream, class_name *const &inPointer)							\
	{																												\
		if (inPointer)																								\
	...
	void		OSWriteDataType(JPH56::IObjectStreamOut &ioStream, class_name *)										\
	{																												\
		ioStream.WriteDataType(JPH56::EOSDataType::Instance);															\
		ioStream.WriteName(#class_name);																			\
	}																												\
	void		OSWriteDataType(JPH56::IObjectStreamOut &ioStream, class_name **)										\
	{																												\
		ioStream.WriteDataType(JPH56::EOSDataType::Pointer);															\
		ioStream.WriteName(#class_name);																			\
	}
