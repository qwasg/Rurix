...
public:																												\
	...
	friend linkage JPH56::RTTI *	GetRTTIOfType(class_name *);														\
	friend inline const JPH56::RTTI *GetRTTI([[maybe_unused]] const class_name *inObject) { return GetRTTIOfType(static_cast<class_name *>(nullptr)); } \
	static void					sCreateRTTI(JPH56::RTTI &inRTTI);														\

// JPH_IMPLEMENT_RTTI_NON_VIRTUAL
#define JPH_IMPLEMENT_RTTI_NON_VIRTUAL(class_name)																	\
	JPH56::RTTI *					GetRTTIOfType(class_name *)															\
	{																												\
		static JPH56::RTTI rtti(#class_name, sizeof(class_name), []() -> void * { return new class_name; }, [](void *inObject) { delete (class_name *)inObject; }, &class_name::sCreateRTTI); \
		return &rtti;																								\
	}																												\
	void						class_name::sCreateRTTI(JPH56::RTTI &inRTTI)											\
...
#define JPH_DECLARE_RTTI_OUTSIDE_CLASS(linkage, class_name)															\
	linkage JPH56::RTTI *			GetRTTIOfType(class_name *);														\
	inline const JPH56::RTTI *	GetRTTI(const class_name *inObject) { return GetRTTIOfType((class_name *)nullptr); }\
	void						CreateRTTI##class_name(JPH56::RTTI &inRTTI);											\

// JPH_IMPLEMENT_RTTI_OUTSIDE_CLASS
#define JPH_IMPLEMENT_RTTI_OUTSIDE_CLASS(class_name)																\
	JPH56::RTTI *					GetRTTIOfType(class_name *)															\
	{																												\
		static JPH56::RTTI rtti((const char *)#class_name, sizeof(class_name), []() -> void * { return new class_name; }, [](void *inObject) { delete (class_name *)inObject; }, &CreateRTTI##class_name); \
		return &rtti;																								\
	}																												\
	void						CreateRTTI##class_name(JPH56::RTTI &inRTTI)
...
public:																												\
	JPH_OVERRIDE_NEW_DELETE																							\
	friend linkage JPH56::RTTI *	GetRTTIOfType(class_name *);														\
	friend inline const JPH56::RTTI *GetRTTI(const class_name *inObject) { return inObject->GetRTTI(); }				\
	virtual const JPH56::RTTI *	GetRTTI() const modifier;															\
	virtual const void *		CastTo(const JPH56::RTTI *inRTTI) const modifier;										\
	static void					sCreateRTTI(JPH56::RTTI &inRTTI);														\
...
#define JPH_IMPLEMENT_RTTI_VIRTUAL(class_name)																		\
	...
	const JPH56::RTTI *			class_name::GetRTTI() const															\
	{																												\
		return JPH_RTTI(class_name);																				\
	}																												\
	const void *				class_name::CastTo(const JPH56::RTTI *inRTTI) const									\
	{																												\
...
#define JPH_IMPLEMENT_RTTI_ABSTRACT(class_name)																		\
	JPH56::RTTI *					GetRTTIOfType(class_name *)															\
	{																												\
		static JPH56::RTTI rtti(#class_name, sizeof(class_name), nullptr, [](void *inObject) { delete (class_name *)inObject; }, &class_name::sCreateRTTI); \
		return &rtti;																								\
	}																												\
	const JPH56::RTTI *			class_name::GetRTTI() const															\
	{																												\
...
#define JPH_DECLARE_RTTI_FOR_FACTORY(linkage, class_name)															\
	linkage JPH56::RTTI *			GetRTTIOfType(class class_name *);
...
#define JPH_BASE_CLASS_OFFSET(inClass, inBaseClass)	((int(JPH56::uint64((inBaseClass *)((inClass *)0x10000))))-0x10000)
