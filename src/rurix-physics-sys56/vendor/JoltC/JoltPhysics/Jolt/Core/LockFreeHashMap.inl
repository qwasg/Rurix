...
#if JPH_DEFAULT_ALLOCATE_ALIGNMENT < 16
	mObjectStore = reinterpret_cast<uint8 *>(JPH56::AlignedAllocate(inObjectStoreSizeBytes, 16));
#else
	mObjectStore = reinterpret_cast<uint8 *>(JPH56::Allocate(inObjectStoreSizeBytes));
#endif
}
