...
// Create a std::hash/JPH56::Hash for DVec3
JPH_MAKE_HASHABLE(JPH56::DVec3, t.GetX(), t.GetY(), t.GetZ())
...
DVec3 DVec3::Sqrt() const
{
	...
	return res;
#else
	return DVec3(JPH56::Sqrt(mF64[0]), JPH56::Sqrt(mF64[1]), JPH56::Sqrt(mF64[2]));
#endif
}

double DVec3::Length() const
{
	return JPH56::Sqrt(Dot(*this));
}
