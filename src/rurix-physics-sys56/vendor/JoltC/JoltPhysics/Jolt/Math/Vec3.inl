...
// Create a std::hash/JPH56::Hash for Vec3
JPH_MAKE_HASHABLE(JPH56::Vec3, t.GetX(), t.GetY(), t.GetZ())
...
Vec3 Vec3::sRandom(Random &inRandom)
{
	...
	float r = JPH56::Sqrt(1.0f - Square(z));
...
Vec3 Vec3::Sqrt() const
{
	...
	return res;
#else
	return Vec3(JPH56::Sqrt(mF32[0]), JPH56::Sqrt(mF32[1]), JPH56::Sqrt(mF32[2]));
#endif
}
...
Vec3 Vec3::GetNormalizedPerpendicular() const
{
	...
	return (xx > yy ? perp_x : perp_y) / JPH56::Sqrt(max(xx, yy) + zz);
#endif // JPH_USE_SSE
}
...
Vec3 Vec3::sDecompressUnitVector(uint32 inValue)
{
	...
	v.SetZ(JPH56::Sqrt(max(1.0f - v.LengthSq(), 0.0f)));
