...
#define JPH_DECLARE_REGISTER_SHADER(name)			namespace JPH56 { class ComputeSystemCPU; JPH_SHADER_WRAPPER_FUNCTION(, name); }

/// Macro to register a shader
#define JPH_REGISTER_SHADER(sys, name)				JPH56::JPH_SHADER_WRAPPER_FUNCTION_NAME(name)(sys)
