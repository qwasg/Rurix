...
**Update (2026-08-24).** The execution mainline has since moved through sixteen more milestones (facts of record: `milestones/*/G*_CONTRACT.md` close-out sections and `registry/`). **G3** (2026-07-19, industrial rendering), **EI1** (2026-07-23, engine integration), **G4** (2026-07-24, engine rendering), **EA1** (2026-07-28, distribution & storefront), **G5** (2026-07-29, native renderer: declarative render graph, virtualized geometry, VSM, screen-probe GI, temporal reconstruction), **G6** (2026-08-01, rendering/physics dual track with Jolt as production default), **G7** (2026-08-05, `g7-closed`, Production Frame Closure), **G8** (2026-08-06, UE5-level prerequisite capabilities), **G9** (2026-08-15, UE5-target rendering/physics platform), **G10** (2026-08-16, UE5 visual-benchmark baseline), **G11** (2026-08-17, GI & lighting quality closure), **G12** (2026-08-17, path-tracing productionization), **G13** (2026-08-19, vendor upscaling — DLSS SR via Streamline NGX Vulkan, FSR 3.1.5, an in-language TSR device lane — and Lumen comparison), **G14** (2026-08-23, formal frame-rate parity: 18/18 at the ×1.00 line), **G15** (2026-08-23, image-quality closure & commercial final review — **double miss honestly recorded**: commercial sign-off 0/18 on the absolute-quality line and performance 17/18 single-cell environment event, carried over to G16+), and **G16** (2026-08-24, `g16-closed`, incl. G16plus: UE cornell reference-arm repaired, absolute quality 18/18 under a programmatically calibrated threshold, the historical 0/18 record left unrewritten). **G17 — DLSS performance-gap closure, the statutory carrier of the G15-MD-F1 miss — is in progress** (chartered and implementation-unlocked 2026-08-24; RFC-0032 D3D12-host NGX lane approved after adversarial review; measured baseline an honest-red 17/18, focus-cell ratio 0.9810; wave G17.2 dual-end re-test & warm-state recalibration accepted, later waves executing the same day with terminal states landing append-only in the contract's §8; both final outcomes — 18/18 or a maintained honest miss registration — are legitimate closures).
...
- **AI-contribution policy (D-406 v2.0, in force; restated 2026-06-29).** The AI agent holds full autonomous decision-making and execution authority — the earlier human-in-the-loop approval gates and human-only zones were lifted (see `10_GOVERNANCE.md` §7 v2.0). What remains mandatory: provenance tags (`Assisted-by: <tool>:<model>`), machine-verifiable evidence before merge, high-sensitivity surfaces (UB clauses, memory-model mappings, FFI ABIs, safety envelopes) still routed through a Full RFC as the record-keeping vehicle, and cross-tool adversarial review of Full RFCs (D-409 — formally Proposed, exercised on RFC-0019 through RFC-0032).
