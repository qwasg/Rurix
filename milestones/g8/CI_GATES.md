...
| `g8.p0.m29.shader_permutation` | M29 | G8.2 | `ci/g8_shader_permutation_smoke.py` | `post-G7 actual-next-free allocation` |
| `g8.p0.m30.pso_cache` | M30 | G8.2 | `ci/g8_pso_cache_smoke.py` | `post-G7 actual-next-free allocation` |
| `g8.p0.m31.reflection_hash` | M31 | G8.2 | `ci/g8_reflection_hash_smoke.py` | `post-G7 actual-next-free allocation` |
| `g8.p0.m32.capability_profile` | M32 | G8.2 | `ci/g8_capability_profile_smoke.py` | `post-G7 actual-next-free allocation` |
...
| `g8.p0.m81.gltf_import` | M81 | G8.3 | `ci/g8_gltf_import_smoke.py` | `post-G7 actual-next-free allocation` |
| `g8.p0.m01.meshlet_page_builder` | M01 | G8.3 | `ci/g8_meshlet_page_builder_smoke.py` | `post-G7 actual-next-free allocation` |
...
| `g8.p1.m83.texture_transcode` | M83 | G8.3 | `ci/g8_texture_transcode_smoke.py` | `post-G7 actual-next-free allocation` |
