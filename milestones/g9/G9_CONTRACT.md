...
### §8.9 G9.8b close-out READY（G-G9-11，2026-08-15）

- **收口门 `g9.wave.8b.closeout` VERDICT=READY**（步骤 172，evidence `evidence/g9_wave8b_closeout_20260815T034218Z.json`，exit=0，schema validate 通过）。终审八 facts 全 PASS：**①34 key**（15 P0 + 19 go P1）逐门 PASS 34/34；**②wave2~8a 七聚合门**（exit×5 + decisions + soak）全 PASS 7/7；**③验收映射三向** `check_g9_acceptance_map` exit=0；**④P2 决策表**最新 evidence `host_section_pass`（33 行闭集最终状态无漂移）；**⑤budget --strict** 非空零 estimated/skip；**⑥8a full-run 先行**（`g9_stabilization_soak_20260815T033526Z`，`base_commit_8a=1d298017` 留痕）；**⑦RD 最终状态逐字一致**（deferred.json RD-034/039/040/041/042/043/044 七条目级 status 全 open 逐字 + `G9_P2_DECISIONS.md` 33 行 FROZEN_IDS 闭集在树——验收映射、候选决策、RD 最终状态三面逐字一致，G-G9-11 字面）；**⑧最后新绿 UTC 日留痕**（`last_new_green_utc=20260815` 与运行日相同，同日 close-out 不阻断——立项裁决 6 同日放行先例援引，8a full-run 先行完成）。
- **同日放行登记**：8a full-run 于 2026-08-15 03:35Z 完成 PASS，8b 终审于同日 03:42Z READY；先例字面不扩展解释（soak 双阈值实测满足未跳过；G8 §8.25 同模）。
