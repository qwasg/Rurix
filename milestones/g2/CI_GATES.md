...
| 46 | DXIL codegen 冒烟(契约 G-G2-2 通道;G2.2 落地接入,**Full RFC + D-131 裁决后**):MIR→DXIL codegen + DXIL 文本 golden 核对 + device 真跑数值/呈现对照 + 内建篡改 codegen 红绿;无 D3D12/GPU → 降级 SKIP | 是 |
