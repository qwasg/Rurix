...
5. close-out 附 `budget_eval --strict` 输出原文(契约 G-M6-2 LSP 延迟 measured_local 与全局零 estimated 残留判定)+ 离线重建复现证据路径 + 离线重建红绿 run URL + RD-003/RD-004/RD-005 收编/处置 close 留痕。
