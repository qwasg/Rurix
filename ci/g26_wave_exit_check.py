#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Assisted-by: Cursor Agent（G26 波聚合门）
"""G26 波聚合门（参数化 g26.wave.{2..6}.exit）。"""
...
ROOT = wel.ROOT
SCHEMA_PATH = ROOT / "milestones/g26/g26_wave_exit_evidence_schema.json"
WAVES: dict[str, tuple[str, str, int]] = {
    "g26.wave.2.exit": ("G26.2", "g26_m_a_framegen_device_kernel", 449),
    "g26.wave.3.exit": ("G26.3", "g26_m_b_framegen_device_bench_accounting", 451),
    "g26.wave.4.exit": ("G26.4", "g26_m_c_rd045_backfill_rejudgment", 453),
    "g26.wave.5.exit": ("G26.5", "g26_m_d_g17_md_f1_rejudgment_window", 455),
    "g26.wave.6.exit": ("G26.6", "g26_m_e_closed_gate_no_regression", 457),
}
...
def run_gate(gate_key: str) -> int:
    ...
    code, _ = wel.emit_wave_evidence(
        wave=wave, subject=f"g26_wave{n}_exit", symbolic_gate_key=gate_key, numeric_step=step,
        source_ref="G26_CONTRACT §2", required_gate_rows=[], extra_facts=facts, subjects=[],
        schema_path=SCHEMA_PATH, evidence_basename=f"g26_wave{n}_exit",
        notes=f"G26 wave {n} exit", host_section_pass=overall,
    )
