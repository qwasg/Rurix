...
# Markers in the full 0001..0009 build. The fallback marker carries the
# 0007-level native-handle-mapping wording (NOT the 0002-level wording the
# tracked 0001+0002+0003 build prints for segment 4g).
FALLBACK_MARKER = (
...
KNOWN_GAPS = [
    ...
    (
        ...
        "real_dispatch_path_not_linked and single-level dispatch covers Godot "
        "level 0 only (no pyramid cascade writeback beyond the scaffolded "
        "patch 0010 result writeback)"
    ),
]
