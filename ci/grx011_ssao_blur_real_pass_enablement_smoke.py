...
# ssao_blur dispatch_recording_smoke opt-in (it now gates the per-dispatch
...
def write_smoke_project(
    ...
    *,
    ...
    the candidate/forced legs arm the ssao_blur
...
rurix_accel/passes/ssao_blur/dispatch_recording_smoke={flag(dispatch_recording_smoke)}
