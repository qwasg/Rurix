...
对比基准 ref(优先级:命令行参数 > GITHUB_BASE_REF > tag m6-closed):
...
def resolve_base() -> str:
    ...
    # M6 终审收官起回退基准切至 m6-closed(M6 CI_GATES §6 / M6_CONTRACT §8.11;
    # 切换前双基准核对 m5-closed PASS + m6-closed PASS,反 YAML-only)
    return "m6-closed"
