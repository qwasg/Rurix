...
对比基准 ref(优先级:命令行参数 > GITHUB_BASE_REF > tag m5-closed):
...
def resolve_base() -> str:
    ...
    # M5 终审收官起回退基准切至 m5-closed(M5 CI_GATES §6 / M5_CONTRACT §8.10;
    # 切换前双基准核对 m4-closed PASS + m5-closed PASS,反 YAML-only)
    return "m5-closed"
