...
| 命名空间 | 已用 | 下一个未用 |
|---|---|---|
| Full RFC `RFC-####` | RFC-0001（[`0001-cuda-d3d12-interop.md`](0001-cuda-d3d12-interop.md)，G1.1）· RFC-0002（[`0002-shader-stages.md`](0002-shader-stages.md)，G2.1，**Owner Approved 2026-06-23**）· RFC-0003（[`0003-dxil-backend.md`](0003-dxil-backend.md)，G2.2 MIR→DXIL 第二后端，**Owner Approved 2026-06-23**）· RFC-0004（[`0004-spirv-dxil-graphics-backend.md`](0004-spirv-dxil-graphics-backend.md)，G2.2 图形=B，**Owner Approved 2026-06-25**）· RFC-0005（[`0005-binding-layout-inference.md`](0005-binding-layout-inference.md)，G2.3 绑定布局推导，**Draft 待 owner FCP-lite 批准**） | RFC-0006 |
