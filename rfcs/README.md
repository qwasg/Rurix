...
> **RFC 台账校准（2026-08-02，number_ledger v1.38）**：上表 Full RFC 行尾的“RFC-0018（自由池）”是 G7.1 materialize 后遗留的历史快照；[`RFC-0018`](0018-compute-rayquery-device-frame.md) 已为 **Agent Approved**，当前下一个未用 Full RFC 为 **RFC-0019**。本追加式校准优先于该行旧尾注。
